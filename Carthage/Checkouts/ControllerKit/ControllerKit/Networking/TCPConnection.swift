...
final class TCPConnection : NSObject, GCDAsyncSocketDelegate {
    ...
    func deregisterWriteChannel<T: Marshallable>(channel: TCPWriteChannel<T>) {
...
final class TCPReadChannel<T: Marshallable> : _ReadableChannel {
    let identifier: UInt16
    var onReceive: ((T) -> ())?
...
final class TCPWriteChannel<T: Marshallable> : _WritableChannel {
    let identifier: UInt16
